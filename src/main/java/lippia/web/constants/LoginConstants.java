...
public class LoginConstants {
    ...
    public static final String INACTIVE_LOG_IN_BUTTON ="xpath://button[@data-test-id='login-button'][@class='cl-btn cl-btn-block cl-btn-primary ng-tns-c128-3']";
    public static final String LOG_IN_MANUALLY_BUTTON = "xpath://a[@data-test-id='login-manual'][@class='cl-d-block cl-text-center ng-tns-c128-2 ng-star-inserted'][contains(.,'Log in manually')]";
